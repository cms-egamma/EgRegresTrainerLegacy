...
public:
  ...
  //accessors
  int getCode(const std::string& descript)const;
  void getCodeName(int code,std::string& id)const;
  std::string getCodeName(int code)const{std::string id;getCodeName(code,id);return id;}
  
  //modifiers
  void setCode(const std::string& descript,int code);
