...
//  fitMax = 1.3;//original
  ...
  std::vector<std::pair<std::string,std::string> > varsTree2 = {
    ...
    {"( (sc.rawEnergy+sc.rawESEnergy)*regRealMean<200 && (sc.rawEnergy+sc.rawESEnergy)*regRealMean/ele.trkPMode>0.025 && ele.trkPModeErr<10*ele.trkPMode && abs((sc.rawEnergy+sc.rawESEnergy)*regRealMean-ele.trkPMode) < 15*sqrt((ele.trkPModeErr)*(ele.trkPModeErr)+((sc.rawEnergy+sc.rawESEnergy)*regRealMean)*(sc.rawEnergy+sc.rawESEnergy)*regRealMean*regRealSigma*regRealSigma) )/(mean*invTar)+( (!( (sc.rawEnergy+sc.rawESEnergy)*regRealMean<200 && (sc.rawEnergy+sc.rawESEnergy)*regRealMean/ele.trkPMode>0.025 && ele.trkPModeErr<10*ele.trkPMode && abs((sc.rawEnergy+sc.rawESEnergy)*regRealMean-ele.trkPMode) < 15*sqrt((ele.trkPModeErr)*(ele.trkPModeErr)+((sc.rawEnergy+sc.rawESEnergy)*regRealMean)*(sc.rawEnergy+sc.rawESEnergy)*regRealMean*regRealSigma*regRealSigma)) )/(regRealMean*(sc.rawEnergy+sc.rawESEnergy)/mc.energy)) ","corrected E-p combination"},
//    {"( (sc.rawEnergy+sc.rawESEnergy)*regRealMean/ele.trkPMode>0.025 && ele.trkPModeErr<10*ele.trkPMode && abs((sc.rawEnergy+sc.rawESEnergy)*regRealMean-ele.trkPMode) < 15*sqrt((ele.trkPModeErr)*(ele.trkPModeErr)+((sc.rawEnergy+sc.rawESEnergy)*regRealMean)*(sc.rawEnergy+sc.rawESEnergy)*regRealMean*regRealSigma*regRealSigma) )/(mean*invTar)+( (!( (sc.rawEnergy+sc.rawESEnergy)*regRealMean/ele.trkPMode>0.025 && ele.trkPModeErr<10*ele.trkPMode && abs((sc.rawEnergy+sc.rawESEnergy)*regRealMean-ele.trkPMode) < 15*sqrt((ele.trkPModeErr)*(ele.trkPModeErr)+((sc.rawEnergy+sc.rawESEnergy)*regRealMean)*(sc.rawEnergy+sc.rawESEnergy)*regRealMean*regRealSigma*regRealSigma)) )/(regRealMean*(sc.rawEnergy+sc.rawESEnergy)/mc.energy)) ","corrected E-p combination"},
