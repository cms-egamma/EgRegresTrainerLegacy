...
def main():
    ...
    regArgs.do_eb = False
    forest_ee_file = regArgs.output_name()
    input_real_ic = "/mercury/data1/harper/BParking_pt1To30Ntup/doubleElectron_FlatPt-1To300_FlatPU0to70RAW_102X_upgrade2018_realistic_v15-v1_BParkRECO_ntup.root"
    ...
    subprocess.Popen(["bin/slc6_amd64_gcc700/RegressionApplierExe",input_real_ic,input_for_comb,"--gbrForestFileEE",forest_ee_file,"--gbrForestFileEB",forest_eb_file,"--nrThreads","4","--treeName",regArgs.tree_name,"--writeFullTree","1"]).communicate()
    

    #step3 make a new tree with the calo only regression included
